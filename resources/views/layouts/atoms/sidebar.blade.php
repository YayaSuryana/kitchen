<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="{{route('dashboard')}}" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-semibold ms-2">Kitchen</span>
        </a>
        ...
        <li class="menu-item {{Request::is('about*')?'active':''}}">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item">
                    ...
                    <div data-i18n="Without navbar">Add About</div>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li class="menu-item {{Request::is('testimoni*')?'active':''}}">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item">
                    ...
                    <div data-i18n="Without navbar">Add Testimoni</div>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li class="menu-item {{Request::is('article*')?'active':''}}">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item">
                    ...
                    <div data-i18n="Without navbar">Add Article</div>
                    </a>
                </li>
            </ul>
        </li>
